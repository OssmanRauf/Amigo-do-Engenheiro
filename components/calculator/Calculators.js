...
export default function Calculator({
  ...
  const {styles, customizeTheme, isLoading} = useValue();
  ...
  const SuperScriptText = ({style, text, supText}) => (
    <View style={{flexDirection: 'row', alignItems: 'flex-start'}}>
      ...
      <Text style={{fontSize: style.fontSize * 0.6, color: style.color}}>
        {supText}
      </Text>
    </View>
  );
    ...
    <View style={{flex: 3}}>
      <View style={styles.row}>
        ...
        <TouchableOpacity
          style={styles.button}
          onPressIn={() =>
            functionPressed('exp(', 'exp(x) - e to the power of x')
          }>
      ...
      <View style={styles.row}>
        <Invertable
          ...
          yes={{
            children: (
              <SuperScriptText style={styles.button} text="sin" supText="-1" />
            ),
        ...
        <Invertable
          ...
          yes={{
            children: (
              <SuperScriptText style={styles.button} text="cos" supText="-1" />
            ),
        ...
        <Invertable
          ...
          yes={{
            children: (
              <SuperScriptText style={styles.button} text="tan" supText="-1" />
            ),
        ...
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => functionPressed('ln(', 'Natural Log(x)')}>
          <StyledText style={styles.button}>ln</StyledText>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => functionPressed('log(')}>
      ...
      <View style={styles.row}>
        <Invertable
          ...
          yes={{
            children: (
              <SuperScriptText style={styles.button} text="sinh" supText="-1" />
            ),
        ...
        <Invertable
          ...
          yes={{
            children: (
              <SuperScriptText style={styles.button} text="cosh" supText="-1" />
            ),
        ...
        <Invertable
          ...
          yes={{
            children: (
              <SuperScriptText style={styles.button} text="tanh" supText="-1" />
            ),
        ...
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => functionPressed('atan2(')}>
        ...
        <TouchableOpacity
          style={{
            ...
            backgroundColor: inverted
              ? styles.buttonNumber.backgroundColor
              : styles.button.backgroundColor,
          }}
          onPressIn={() => setInverted(!inverted)}>
  ...
  const Actions = () => (
    <View style={{flex: 5}}>
      <View style={styles.row}>
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => functionPressed('sqrt(', 'square root = √x')}>
          <StyledText style={styles.button}>√</StyledText>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPress={() => buttonPressed('(', `long press for entering ")"`)}
          onLongPress={() => buttonPressed(')')}>
          <StyledText style={styles.button}>( )</StyledText>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => buttonPressed('!', 'Factorial')}>
          <StyledText style={styles.button}>n!</StyledText>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => buttonPressed('%', ' x % y (x modulo y)')}>
          <StyledText style={styles.button}>%</StyledText>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.button}
      ...
      <View style={styles.row}>
        <TouchableOpacity
          style={styles.button}
          onPressIn={() => functionPressed('cbrt(', 'cube root = ∛x')}>
          <StyledText style={styles.button}>∛</StyledText>
        </TouchableOpacity>
        <TouchableOpacity
      ...
      <View style={styles.row}>
        <TouchableOpacity
          style={styles.button}
          onPressIn={() =>
            buttonPressed('^', 'x^y (x raised to the power of y)')
          }>
